    ...
    <>
      ...
      <Section padding={'48px 0'}>
        <InfoRow reverse={true}>
          <ImageSection>
            <ImagePlace src={'/static/images/Reports.png'} />
          </ImageSection>
          <TextSection>
      ...
      <Section padding={'48px 0'}>
        <InfoRow>
          ...
          <ImageSection>
            <ImagePlace src={'/static/images/Channels.png'} />
          </ImageSection>
        </InfoRow>
      </Section>
      <Section padding={'48px 0'}>
        <InfoRow reverse={true}>
          <ImageSection>
            <ImagePlace src={'/static/images/Forwards.png'} />
          </ImageSection>
          <TextSection>
      ...
      <Section padding={'48px 0 80px'}>
        <InfoRow>
          ...
          <ImageSection>
            <ImagePlace src={'/static/images/NightLight.png'} />
          </ImageSection>
        </InfoRow>
      </Section>
    </>
